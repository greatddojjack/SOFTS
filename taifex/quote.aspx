                            ...
                            <div class="row">
                                <div class="col-xs-3">
                                    <div class="form-group">
                                        <label>更新頻率(<span id="refreshSecond">幾</span>秒後更新)</label>
                                ...
                                <div class="col-xs-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="passCode" name="passCode" placeholder="PassCode" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-xs-3">
                                    <div class="form-group">
                                        <label>履約年月週</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" id="contractMonthWeek" name="contractMonthWeek" placeholder="履約年月週" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>停損</label>
                                    ...
                                    <div class="form-group">
                                        <label>報價來源</label>
                                        <div class="input-group">
                                            <select class="input-group" id="quoteSource">
                                                <option value="GetTaiOptInfo">Yahoo期權</option>
                                                <option value="GetTaiOptInfoFromDDE">華南好神期DDE</option>
                                            </select>
                                        </div>
                                    </div>
                                    <label></label>
